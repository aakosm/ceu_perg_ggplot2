...
- Give an overview of the state of the art data visualization practices in R
- Provide an accessible way into `ggplot2`
...
```{r}
ggplot(data = midwest,
       aes(x = popdensity, y = popblack, color = state)) + 
